...
export default function Index() {
  ...
  return (
    <div className="flex h-screen bg-white overflow-hidden">
      ...
      <div
        className={`fixed lg:relative z-30 lg:z-0 ${sidebarOpen ? "translate-x-0" : "-translate-x-full lg:translate-x-0"} transition-transform duration-300`}
      >
        <Sidebar />
      </div>
          ...
          <div className="flex items-center gap-3 px-4 sm:px-5 py-4 mb-6 rounded-lg border border-[#BEDBFF] bg-gradient-to-r from-[#DBEAFE] to-[#E0E7FF] shadow-sm">
            <div className="relative w-[38px] h-[38px] flex-shrink-0">
              <div className="absolute inset-0 flex items-center justify-center">
                ...
                >
                  <path
                    d="M17.2605 6.77334L17.055 7.24474C16.9047 7.58985 16.4274 7.58985 16.2769 7.24474L16.0715 6.77334C15.7053 5.93281 15.0456 5.26359 14.2224 4.89749L13.5893 4.61594C13.2471 4.46369 13.2471 3.96559 13.5893 3.81335L14.187 3.54754C15.0313 3.17201 15.7028 2.47803 16.0628 1.60894L16.2738 1.09953C16.4208 0.744493 16.9112 0.744493 17.0582 1.09953L17.2692 1.60894C17.6292 2.47803 18.3007 3.17201 19.145 3.54754L19.7426 3.81335C20.0849 3.96559 20.0849 4.46369 19.7426 4.61594L19.1096 4.89749C18.2864 5.26359 17.6268 5.93281 17.2605 6.77334ZM18.3327 16.6666V8.88209C17.8113 9.06634 17.2504 9.16659 16.666 9.16659C15.7553 9.16659 14.9014 8.92309 14.166 8.49767V14.1666H12.4993V8.33325H13.9012C12.5539 7.43749 11.666 5.90573 11.666 4.16659C11.666 3.58219 11.7663 3.02122 11.9505 2.49992H2.49935C2.03912 2.49992 1.66602 2.87302 1.66602 3.33325V16.6666C1.66602 17.1268 2.03912 17.4999 2.49935 17.4999H17.4993C17.9596 17.4999 18.3327 17.1268 18.3327 16.6666ZM5.83268 10.8333H7.49935V14.1666H5.83268V10.8333ZM9.16602 5.83325H10.8327V14.1666H9.16602V5.83325Z"
                    fill="white"
                  />
                </svg>
              </div>
          ...
          <div className="border border-neutral-200 rounded-lg shadow-sm">
            ...
            <div className="p-3 sm:p-4 space-y-2.5">
              ...
              <ConversationItemCollapsed
                number={2}
                title="이번 주 받은 메일 요약해서 알려줘"
              />
              <ConversationItemCollapsed
                number={3}
                title="우리 회사 휴가 규정에 대해 간략하게 알려줘"
              />
            </div>
          </div>
        </div>
...
function StatCard({
  ...
  return (
    <div className="border border-neutral-200 rounded-lg p-4 shadow-sm">
      ...
      <div className="text-2xl sm:text-[30px] font-bold text-text-primary leading-[1.33]">
        {value}
      </div>
    </div>
  );
...
function AgentTopCard() {
  return (
    <div className="border border-neutral-200 rounded-lg p-4 shadow-sm">
      <div className="text-xs sm:text-sm font-bold text-text-primary mb-3 sm:mb-4">
        오늘 사용된 에이전트 TOP 3
      </div>
...
function AgentItem({
  ...
  return (
    <div className="flex items-center gap-2">
      <div
        className={`flex items-center justify-center w-[23px] h-5 rounded-md ${bgColors[color as keyof typeof bgColors]} px-1.5 flex-shrink-0`}
      >
        <span
          className={`text-xs sm:text-sm font-bold ${textColors[color as keyof typeof textColors]}`}
        >
          {number}
        </span>
      </div>
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 sm:gap-0 px-3 py-2.5 bg-white border-b border-neutral-200">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          <button className="w-8 h-8 flex items-center justify-center rounded hover:bg-neutral-50 flex-shrink-0">
            ...
            >
              <path
                d="M9 6.22119L4.5 10.7212L5.5575 11.7787L9 8.34369L12.4425 11.7787L13.5 10.7212L9 6.22119Z"
                fill="#45556C"
              />
            </svg>
          </button>
          ...
          <div className="flex flex-col gap-1.5 flex-1 min-w-0">
            <div className="bg-neutral-100 rounded-[2px_26px_26px_26px] px-4 sm:px-5 py-3 sm:py-3.5">
              <div className="text-xs sm:text-sm text-neutral-900 whitespace-pre-line break-words">
                이번 주 일정은 다음과 같습니다. ## 📆 **일정 개요** - 총 일정 :
                2개 - 총 시간 : 총 2.0시간 ## 11월 25일 (화) - **10:30 ~ 11:30 |
                AgentGO3.0 요구사항정의서 2차 리뷰** - 참석자:
                김민수(minsu@example.com), 이지은(jiun@example.com),
                최영호(youngho@example.com) - 장소: Microsoft Teams 모임
              </div>
            </div>
            <div className="flex items-center gap-1">
              <button className="w-8 h-8 flex items-center justify-center rounded hover:bg-neutral-50">
...
function ConversationItemCollapsed({
  number,
  title,
}: {
  number: number;
...
function InboxUnarchiveIcon() {
  return (
    <div className="relative w-[38px] h-[38px]">
      ...
      >
        <path
          d="M16.666 2.5L18.3327 5.83333V16.6667C18.3327 17.1269 17.9596 17.5 17.4993 17.5H2.49935C2.03912 17.5 1.66602 17.1269 1.66602 16.6667V5.83627L3.33268 2.5H16.666ZM9.99935 8.33333L6.66602 11.6667H9.16602V15H10.8327V11.6667H13.3327L9.99935 8.33333ZM15.636 4.16667H4.36268L3.53018 5.83333H16.4693L15.636 4.16667Z"
          fill="white"
        />
      </svg>
    </div>
...
function InboxArchiveIcon() {
  return (
    <div className="relative w-[38px] h-[38px]">
      ...
      >
        <path
          d="M3.33268 2.5H16.666L18.3327 5.83333V16.6667C18.3327 17.1269 17.9596 17.5 17.4993 17.5H2.49935C2.03912 17.5 1.66602 17.1269 1.66602 16.6667V5.83627L3.33268 2.5ZM10.8327 11.6667V8.33333H9.16602V11.6667H6.66602L9.99935 15L13.3327 11.6667H10.8327ZM16.4693 5.83333L15.6359 4.16667H4.36315L3.53055 5.83333H16.4693Z"
          fill="white"
        />
      </svg>
    </div>
...
function ArchiveStackIcon() {
  return (
    <div className="relative w-[38px] h-[38px]">
      ...
      >
        <path
          d="M3.33333 4.16667H16.6667V2.5H3.33333V4.16667ZM16.6667 7.5H3.33333V5.83333H16.6667V7.5ZM7.5 10.8333H12.5V9.16667H17.5V16.6667C17.5 17.1269 17.1269 17.5 16.6667 17.5H3.33333C2.8731 17.5 2.5 17.1269 2.5 16.6667V9.16667H7.5V10.8333Z"
          fill="white"
        />
      </svg>
    </div>
